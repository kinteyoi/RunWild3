...
@onready var snakegon = preload("res://Assets/Players/Snakegon/Kritter2_Baby.png")



var available_pets = ["deerdog", "penggon", "snakegon"]
signal finished
